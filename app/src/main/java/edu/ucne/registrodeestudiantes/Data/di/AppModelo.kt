...
import edu.ucne.registrodeestudiantes.Data.Repository.TipoPenalidadRepositoryImpl
...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideTipoPenalidadDao(estudianteDB: DBEstudiante) : TipoPenalidadDao{
